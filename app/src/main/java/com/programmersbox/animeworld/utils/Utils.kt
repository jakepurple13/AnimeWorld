...
fun ShowDbModel.toShow() = ShowInfo(title, showUrl, source)
...
fun loadGenres(view: ChipGroup, genres: List<String>?) {
    genres?.forEach {
    ...
    setOnNavigationItemSelectedListener { item ->
        ...
        if (fragmentManager.isStateSaved) {
            ...
            if (selectedItemTag != newlySelectedItemTag) {
                ...
                //val navigator = KeepStateNavigator(context, selectedFragment.childFragmentManager, containerId)
                //selectedFragment.navController.navigatorProvider.addNavigator(navigator)
